...
NSString *const MJRefreshHeaderIdleText = @"下拉可以更新";
NSString *const MJRefreshHeaderPullingText = @"鬆開立刻更新";
NSString *const MJRefreshHeaderRefreshingText = @"正在更新數據中...";
...
NSString *const MJRefreshBackFooterNoMoreDataText = @"已经全部加載完畢";